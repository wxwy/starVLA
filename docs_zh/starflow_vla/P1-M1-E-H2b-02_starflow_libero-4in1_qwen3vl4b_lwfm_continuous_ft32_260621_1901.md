...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  8.5 us,  4.8 sy,  0.0 ni, 86.5 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.8 GiB |
| **内存可用** | 910.7 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 5小时 5分钟 × 5.58 元/h ≈ **162.35 元** |
| **预计总成本** | 6天 4小时 53分钟 × 5.58 元/h ≈ **830.80 元** |
| **剩余预计成本** | 4天 23小时 47分钟 × 5.58 元/h ≈ **668.45 元** |
