...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 21.9 us,  6.4 sy,  0.0 ni, 71.0 id,  0.4 wa,  0.0 hi,  0.3 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 112.4 GiB |
| **内存可用** | 895.1 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 18小时 2分钟 × 5.58 元/h ≈ **100.64 元** |
| **预计总成本** | 6天 4小时 0分钟 × 5.58 元/h ≈ **825.84 元** |
| **剩余预计成本** | 5天 9小时 57分钟 × 5.58 元/h ≈ **725.20 元** |
