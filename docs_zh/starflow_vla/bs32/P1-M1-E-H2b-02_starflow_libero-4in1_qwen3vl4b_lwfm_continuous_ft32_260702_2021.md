...
> 最后更新：2026-07-06 02:26:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **40060 / 80000**（50.1%） |
| **完成比例** | 50.1% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_40000` |
| **上一个 checkpoint** | `steps_39750` |
