...
> **状态**: 🟢 训练运行中（step 87/80000，约 0.11%）  
> **启动时间**: 2026-06-21 14:21:08 CST  
> **当前更新**: 2026-06-21 14:32:35 CST  
> **tmux 会话**: `train`  
...
| `/localdisk-tmp` | 100 G | 12 K | 100 G | 1% |
...
|------|------|
| **每 step 耗时** | ~7.30 秒 |
| **每 step 成本** | 5.58 / 3600 × 7.30 ≈ **0.0113 元** |
| **已产生成本** | ~0.19 h × 5.58 ≈ **1.05 元** |
| **完整 80000 steps 预估** | 80000 × 7.30s = 162h ≈ **903.8 元** |
