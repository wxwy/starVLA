...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 11.0 us,  4.9 sy,  0.0 ni, 84.0 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.3 GiB |
| **内存可用** | 911.2 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 2小时 5分钟 × 5.58 元/h ≈ **145.57 元** |
| **预计总成本** | 6天 5小时 20分钟 × 5.58 元/h ≈ **833.28 元** |
| **剩余预计成本** | 5天 3小时 14分钟 × 5.58 元/h ≈ **687.71 元** |
