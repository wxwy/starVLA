...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **22945 / 80000**（28.68%） |
| **单步耗时** | ~9.15 s/it |
| **已运行时间** | 约 58 小时 59 分钟 |
| **预计剩余时间** | ~145 小时（约 6.0 天） |
| **最新 checkpoint** | `steps_22750` |
| **上一个 checkpoint** | `steps_22500` |
| **下一轮 eval** | `steps_23000`（~55 steps 后）🔥 |
...
- 最新 checkpoint **steps_22750** 已于 06:44 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_22750/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_22750`。
