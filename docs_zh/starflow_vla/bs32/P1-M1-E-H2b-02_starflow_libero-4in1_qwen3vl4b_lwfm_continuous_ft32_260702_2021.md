...
> 最后更新：2026-07-03 20:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **12220 / 80000**（15.3%） |
| **完成比例** | 15.3% |
| **单步耗时** | ~6.9-7.6 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.27 s |
| **已运行时间** | 约 23 小时 51 分钟 |
| **预计剩余时间** | ~135 小时（约 5.6 天） |
| **最新 checkpoint** | `steps_12000` |
| **上一个 checkpoint** | `steps_11750` |
...
| **Docker 内存已用** | 39.0 GiB |
| **Docker 内存可用** | ~17.0 GiB |
| **Swap** | 0 B |
