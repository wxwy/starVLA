...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **29944 / 80000**（37.43%） |
| **单步耗时** | ~9.17 s/it |
| **已运行时间** | 约 76 小时 59 分钟 |
| **预计剩余时间** | ~127 小时（约 5.3 天） |
| **最新 checkpoint** | `steps_29750` |
| **上一个 checkpoint** | `steps_29500` |
| **下一轮 eval** | `steps_30000`（~56 steps 后）🔥 |
...
| 29940 | 0.0572 | 0.0447 | |
| 29944 | — | — | 🔵 当前 |
| **250–29750** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_29750** 已于 00:45 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_29750/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_29750`。
