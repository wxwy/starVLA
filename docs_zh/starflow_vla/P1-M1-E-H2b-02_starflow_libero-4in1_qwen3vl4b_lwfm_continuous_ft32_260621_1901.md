...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 19.4 us,  5.2 sy,  0.0 ni, 75.1 id,  0.0 wa,  0.0 hi,  0.3 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 105.1 GiB |
| **内存可用** | 902.4 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 23小时 29分钟 × 5.58 元/h ≈ **131.12 元** |
| **预计总成本** | 6天 5小时 6分钟 × 5.58 元/h ≈ **832.04 元** |
| **剩余预计成本** | 5天 5小时 36分钟 × 5.58 元/h ≈ **700.92 元** |
