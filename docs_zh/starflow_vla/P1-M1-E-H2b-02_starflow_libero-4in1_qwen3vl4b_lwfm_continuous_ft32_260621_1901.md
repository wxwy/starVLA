...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 16.0 us,  3.1 sy,  0.0 ni, 80.8 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 117.8 GiB |
| **内存可用** | 889.7 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 19小时 31分钟 × 5.58 元/h ≈ **108.92 元** |
| **预计总成本** | 6天 4小时 53分钟 × 5.58 元/h ≈ **830.80 元** |
| **剩余预计成本** | 5天 9小时 22分钟 × 5.58 元/h ≈ **721.88 元** |
