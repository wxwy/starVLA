...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  5.0 us,  1.3 sy,  0.0 ni, 93.6 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 87.0 GiB |
| **内存可用** | 920.5 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 1小时 35分钟 × 5.58 元/h ≈ **142.83 元** |
| **预计总成本** | 6天 4小时 53分钟 × 5.58 元/h ≈ **830.80 元** |
| **剩余预计成本** | 5天 3小时 17分钟 × 5.58 元/h ≈ **687.97 元** |
