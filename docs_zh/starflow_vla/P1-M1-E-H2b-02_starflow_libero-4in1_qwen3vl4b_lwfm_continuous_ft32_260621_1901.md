...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 17.8 us,  6.2 sy,  0.0 ni, 75.8 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 129.0 GiB |
| **内存可用** | 878.5 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 19小时 0分钟 × 5.58 元/h ≈ **106.06 元** |
| **预计总成本** | 6天 5小时 33分钟 × 5.58 元/h ≈ **834.52 元** |
| **剩余预计成本** | 5天 10小时 32分钟 × 5.58 元/h ≈ **728.46 元** |
