...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 14.2 us,  0.5 sy,  0.0 ni, 85.3 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 92.3 GiB |
| **内存可用** | 915.2 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 3小时 58分钟 × 5.58 元/h ≈ **22.18 元** |
| **预计总成本** | 7天 3小时 33分钟 × 5.58 元/h ≈ **957.28 元** |
| **剩余预计成本** | 6天 23小时 34分钟 × 5.58 元/h ≈ **935.10 元** |
