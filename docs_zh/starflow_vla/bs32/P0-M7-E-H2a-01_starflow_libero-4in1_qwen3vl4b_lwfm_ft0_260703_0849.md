...
> 最后更新：2026-07-08 00:37 CST（Docker 容器内实际可用资源）

| 指标 | 值 |
|------|-----|
| **当前 Step** | 59434 / 80,000（74.3%） |
| **完成比例** | 74.3% |
| **单步耗时** | ~6.55 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.199 s |
...
## 自动监控状态**: 🟢 训练运行中（step 59434/80000，约 74.3%）  

| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-07-08 00:37 CST |
| 训练状态**: 🟢 训练运行中（step 59434/80000，约 74.3%）  
| run_id | `P0-M7-E-H2a-01_starflow_libero-4in1_qwen3vl4b_lwfm_ft0_260703_0849` |
| tmux 会话 | `train` |
| 当前步数 | **59434 / 80000** |
| 完成比例 | 74.3% |
