...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **23799 / 80000**（29.75%） |
| **单步耗时** | ~9.15 s/it |
| **已运行时间** | 约 61 小时 10 分钟 |
| **预计剩余时间** | ~143 小时（约 6.0 天） |
| **最新 checkpoint** | `steps_23750` |
| **上一个 checkpoint** | `steps_23500` |
| **下一轮 eval** | `steps_24000`（~201 steps 后） |
...
| 23780 | 0.0637 | 0.0509 | |
| 23799 | — | — | 🔵 当前 |
| **250–23750** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_23750** 已于 09:18 保存并同步至持久存储

---

## 系统资源占用

> 最后更新：2026-07-05 09:30:00 CST
...
├── checkpoints/steps_250/ ... steps_23750/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
