...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  7.1 us,  1.7 sy,  0.0 ni, 91.3 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.1 GiB |
| **内存可用** | 911.4 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 2小时 58分钟 × 5.58 元/h ≈ **16.62 元** |
| **预计总成本** | 6天 19小时 33分钟 × 5.58 元/h ≈ **912.64 元** |
| **剩余预计成本** | 6天 16小时 34分钟 × 5.58 元/h ≈ **896.02 元** |
