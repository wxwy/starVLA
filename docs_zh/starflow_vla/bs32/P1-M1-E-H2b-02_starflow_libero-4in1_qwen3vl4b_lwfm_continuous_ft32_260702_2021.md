...
> 最后更新：2026-07-06 07:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **42540 / 80000**（53.2%） |
| **完成比例** | 53.2% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 82 小时 51 分钟 |
| **预计剩余时间** | ~32 小时（约 1.3 天） |
| **最新 checkpoint** | `steps_42500` |
| **上一个 checkpoint** | `steps_42250` |
