...
> 最后更新：2026-07-05 07:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **30140 / 80000**（37.7%） |
| **完成比例** | 37.7% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 58 小时 51 分钟 |
| **预计剩余时间** | ~85 小时（约 3.5 天） |
| **最新 checkpoint** | `steps_30000` |
| **上一个 checkpoint** | `steps_29750` |
