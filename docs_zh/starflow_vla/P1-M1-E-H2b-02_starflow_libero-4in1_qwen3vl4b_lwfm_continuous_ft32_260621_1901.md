...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 18.5 us,  4.6 sy,  0.0 ni, 76.5 id,  0.0 wa,  0.0 hi,  0.4 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 99.6 GiB |
| **内存可用** | 907.9 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1小时 29分钟 × 5.58 元/h ≈ **8.34 元** |
| **预计总成本** | 6天 5小时 20分钟 × 5.58 元/h ≈ **833.28 元** |
| **剩余预计成本** | 6天 3小时 50分钟 × 5.58 元/h ≈ **824.94 元** |
