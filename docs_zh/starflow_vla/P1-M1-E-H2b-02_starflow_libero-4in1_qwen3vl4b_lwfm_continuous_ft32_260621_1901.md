...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 11.9 us,  3.7 sy,  0.0 ni, 84.3 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 166.8 GiB |
| **内存可用** | 840.7 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 21小时 31分钟 × 5.58 元/h ≈ **120.12 元** |
| **预计总成本** | 6天 4小时 53分钟 × 5.58 元/h ≈ **830.80 元** |
| **剩余预计成本** | 5天 7小时 21分钟 × 5.58 元/h ≈ **710.68 元** |
