...
> 最后更新：2026-07-08 12:36 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **63789 / 80000**（79.7%） |
| **完成比例** | 79.7% |
| **单步耗时** | ~6.68 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.215 s |
| **已运行时间** | 约 123 小时 48 分钟 |
| **预计剩余时间** | ~30.1 小时（约 1.25 天） |
...
| **已运行时间** | 约 123 小时 48 分钟 |
| **完整 80000 steps 预估** | 80000 × 6.68s ≈ 148.4h ≈ 6.2 天 |
...
- GPU 利用率 95%，温度 56°C。
- Docker 内存用量 26.2 GiB / 56.0 GiB（cgroup 实际用量）。
- gradient accumulation fix（commit `abe1e46`）已应用。
- 🏆🏆 **重大突破** step 63740 loss **0.02236**，大幅刷新历史最低！
  - step 63720: 0.02288 | step 63700: 0.02537 | step 63660: 0.02706
  - 旧纪录 0.02825 @ step 57520，一口气突破到 0.022 区间！
- Checkpoint steps_63750 已保存。
