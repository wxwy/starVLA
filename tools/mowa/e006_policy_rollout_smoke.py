"""Run MoWA E-006 RoboCasa365 policy rollout smoke."""
...
ROLLOUT_OUTPUT = Path("docs_zh/mowa/mowa_e006_policy_rollout_smoke.json")
ARTIFACT_ROOT = Path("docs_zh/mowa/e006_policy_rollout")
...
def run_or_plan_e006_policy_rollout_smoke(
    repo_root: Path | str,
    *,
    ...
    checks = {
        "preflight_report_exists": (root / OUTPUT).is_file(),
    ...
    return {
        ...
        "unresolved_items": [
            ...
            "Formal E-006 evidence requires more episodes/seeds after this smoke path is stable.",
        ],
