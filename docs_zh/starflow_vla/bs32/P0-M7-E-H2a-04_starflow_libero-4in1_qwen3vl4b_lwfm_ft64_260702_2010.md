...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **21461 / 80000**（26.83%） |
| **单步耗时** | ~9.14 s/it |
| **已运行时间** | 约 55 小时 10 分钟 |
| **预计剩余时间** | ~149 小时（约 6.2 天） |
| **最新 checkpoint** | `steps_21250` |
| **上一个 checkpoint** | `steps_21000` |
| **下一轮 eval** | `steps_21500`（~39 steps 后）🔥 |
...
| 21460 | 0.0654 | 0.0571 | |
| 21461 | — | — | 🔵 当前 |
| **250–21250** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_21250** 已于 02:54 保存并同步至持久存储

---

## 系统资源占用

> 最后更新：2026-07-05 03:30:00 CST
...
├── checkpoints/steps_250/ ... steps_21250/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_21250`。
