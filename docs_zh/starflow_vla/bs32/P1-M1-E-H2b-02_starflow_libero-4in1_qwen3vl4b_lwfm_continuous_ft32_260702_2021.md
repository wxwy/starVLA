...
> 最后更新：2026-07-05 05:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **29080 / 80000**（36.4%） |
| **完成比例** | 36.4% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 56 小时 51 分钟 |
| **预计剩余时间** | ~90 小时（约 3.8 天） |
| **最新 checkpoint** | `steps_29000` |
| **上一个 checkpoint** | `steps_28750` |
...
| **Docker 内存已用** | 37.8 GiB |
| **Docker 内存可用** | ~18.2 GiB |
| **Swap** | 0 B |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 3.8 天。
- step 29000+ loss 回落至 0.0640，波动正常
