...
> **状态**: 🟢 训练运行中（step 281/80000，约 0.4%）  
> **启动时间**: 2026-06-22 11:48:42 CST  
> **最后训练日志**: 2026-06-22 11:53:47 CST，step 281  
> **当前更新**: 2026-06-22 11:54:00 CST  
...
|------|------|
| **每 step 耗时** | ~1.12 秒 |
| **每 step 成本** | 5.58 / 3600 × 1.12 ≈ **0.0017 元** |
| **已产生成本** | ~0.08 h × 5.58 ≈ **0.47 元** |
| **完整 80000 steps 预估** | 80000 × 1.12s ≈ 24.9h ≈ **138.83 元** |
