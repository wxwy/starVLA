"""MoWA G0 batch-level dataloader smoke check."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MoWA atomic core batch dataloader smoke.")
    parser.add_argument(
        "--data-root",
        type=Path,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[0, 1, 4],
        help="Episode indices to sample per task.",
    )
