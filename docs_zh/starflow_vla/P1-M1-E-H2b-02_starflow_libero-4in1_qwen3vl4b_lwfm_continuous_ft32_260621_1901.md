...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 21.0 us,  3.2 sy,  0.0 ni, 75.3 id,  0.0 wa,  0.0 hi,  0.5 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 99.3 GiB |
| **内存可用** | 908.2 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1小时 59分钟 × 5.58 元/h ≈ **11.13 元** |
| **预计总成本** | 6天 5小时 33分钟 × 5.58 元/h ≈ **834.52 元** |
| **剩余预计成本** | 6天 3小时 33分钟 × 5.58 元/h ≈ **823.39 元** |
