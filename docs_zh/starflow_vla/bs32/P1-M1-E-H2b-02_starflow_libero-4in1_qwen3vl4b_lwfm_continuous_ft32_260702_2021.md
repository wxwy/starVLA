...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **32200 / 80000**（40.3%） |
| **完成比例** | 40.3% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 62 小时 51 分钟 |
| **预计剩余时间** | ~75 小时（约 3.1 天） |
| **最新 checkpoint** | `steps_32000` |
| **上一个 checkpoint** | `steps_31750` |
