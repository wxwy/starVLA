...
| 33440 | 0.0562 | 0.0409 | |
| 33451 | — | — | 🔵 当前 |
| **250–33250** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_33250** 已于 09:44 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_33250/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_33250`。
