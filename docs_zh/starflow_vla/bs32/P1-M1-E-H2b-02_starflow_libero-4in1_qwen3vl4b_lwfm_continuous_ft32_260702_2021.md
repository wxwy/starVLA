...
> 最后更新：2026-07-05 20:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **36860 / 80000**（46.1%） |
| **完成比例** | 46.1% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 71 小时 51 分钟 |
| **预计剩余时间** | ~54 小时（约 2.3 天） |
| **最新 checkpoint** | `steps_36750` |
| **上一个 checkpoint** | `steps_36500` |
