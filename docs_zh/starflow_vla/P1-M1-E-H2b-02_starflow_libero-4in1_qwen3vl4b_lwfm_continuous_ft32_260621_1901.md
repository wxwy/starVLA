...
|------|-----|
| **GPU 利用率** | 100% |
| **显存使用** | 55895 MiB / 81920 MiB (68.2%) |
| **显存空闲** | 25261 MiB |
| **功耗** | 326.38 W / 400.00 W |
| **温度** | 57°C |
...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 19.6 us,  4.9 sy,  0.0 ni, 75.2 id,  0.0 wa,  0.0 hi,  0.4 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 101.1 GiB |
| **内存可用** | 906.4 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 0小时 29分钟 × 5.58 元/h ≈ **2.76 元** |
| **预计总成本** | 6天 13小时 20分钟 × 5.58 元/h ≈ **877.92 元** |
| **剩余预计成本** | 6天 12小时 50分钟 × 5.58 元/h ≈ **875.16 元** |
