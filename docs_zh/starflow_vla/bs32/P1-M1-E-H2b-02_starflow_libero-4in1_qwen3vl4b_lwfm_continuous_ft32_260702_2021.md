...
> 最后更新：2026-07-05 09:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **31140 / 80000**（38.9%） |
| **完成比例** | 38.9% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 60 小时 51 分钟 |
| **预计剩余时间** | ~80 小时（约 3.3 天） |
| **最新 checkpoint** | `steps_31000` |
| **上一个 checkpoint** | `steps_30750` |
...
- step 31140 loss 降至 0.0420，持续创新低 🎯
