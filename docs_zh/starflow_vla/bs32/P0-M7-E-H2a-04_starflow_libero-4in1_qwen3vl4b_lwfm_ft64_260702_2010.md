...
| 25660 | 0.0564 | 0.0688 | |
| 25674 | — | — | 🔵 当前 |
| **250–25500** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_25500** 已于 13:48 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_25500/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_25500`。
