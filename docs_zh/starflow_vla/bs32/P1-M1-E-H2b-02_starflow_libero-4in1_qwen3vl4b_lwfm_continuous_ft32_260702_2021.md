...
> 最后更新：2026-07-05 04:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **28620 / 80000**（35.8%） |
| **完成比例** | 35.8% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_28500` |
| **上一个 checkpoint** | `steps_28250` |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 3.9 天。
- step 28620 loss 回升至 0.0737，波动加大
