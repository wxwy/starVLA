...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 10.9 us,  3.8 sy,  0.0 ni, 85.1 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 100.7 GiB |
| **内存可用** | 906.8 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 3小时 5分钟 × 5.58 元/h ≈ **151.16 元** |
| **预计总成本** | 6天 3小时 33分钟 × 5.58 元/h ≈ **823.36 元** |
| **剩余预计成本** | 5天 0小时 27分钟 × 5.58 元/h ≈ **672.20 元** |
