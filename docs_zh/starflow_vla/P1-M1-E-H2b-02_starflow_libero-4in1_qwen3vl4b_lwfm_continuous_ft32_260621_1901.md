...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 11.4 us,  4.3 sy,  0.0 ni, 84.1 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.1 GiB |
| **内存可用** | 911.4 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 5小时 0分钟 × 5.58 元/h ≈ **161.82 元** |
| **预计总成本** | 6天 3小时 46分钟 × 5.58 元/h ≈ **824.60 元** |
| **剩余预计成本** | 4天 22小时 46分钟 × 5.58 元/h ≈ **662.78 元** |
