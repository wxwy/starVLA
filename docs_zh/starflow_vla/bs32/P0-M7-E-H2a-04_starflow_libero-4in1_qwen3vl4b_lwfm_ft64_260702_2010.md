...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **31892 / 80000**（39.87%） |
| **单步耗时** | ~9.16 s/it |
| **已运行时间** | 约 81 小时 59 分钟 |
| **预计剩余时间** | ~122 小时（约 5.1 天） |
| **最新 checkpoint** | `steps_31750` |
| **上一个 checkpoint** | `steps_31500` |
| **下一轮 eval** | `steps_32000`（~108 steps 后）🔥 |
...
| 31880 | 0.0632 | 0.0648 | |
| 31892 | — | — | 🔵 当前 |
| **250–31750** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_31750** 已于 05:53 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_31750/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_31750`。
