...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  8.7 us,  3.5 sy,  0.0 ni, 87.6 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 97.9 GiB |
| **内存可用** | 909.6 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 2小时 35分钟 × 5.58 元/h ≈ **148.42 元** |
| **预计总成本** | 6天 4小时 0分钟 × 5.58 元/h ≈ **825.84 元** |
| **剩余预计成本** | 5天 1小时 24分钟 × 5.58 元/h ≈ **677.42 元** |
