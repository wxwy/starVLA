...
> 最后更新：2026-07-03 10:39:19 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **~526 / 80000**（0.7%） |
| **完成比例** | 0.8% |
| **单步耗时** | ~6.85 s/it（实测） |
| **模型前向/反向耗时** | ~0.217 s（per micro-step） |
| **数据加载耗时** | <0.001 s |
| **已运行时间** | 约 1 小时 10 分钟 |
| **预计剩余时间** | ~144 小时（约 6.0 天） |
| **最新 checkpoint** | `steps_500`（10:21） |
| **上一个 checkpoint** | `steps_250` |
...
| **当前已用** | ~22.0 GiB（23632207872 bytes） |
| **使用率** | 39.3% |
| **Swap** | 0 B |
