...
> 最后更新：2026-07-03 14:09:31 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **9143 / 80000**（11.4%） |
| **完成比例** | 11.4% |
| **单步耗时** | ~7.09 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.243 s |
...
| 指标 | 值 |
|------|-----|
| **Docker 内存总量** | 120.0 GiB
| **Docker 内存已用** | ~26.4 GiB
| **Docker 内存可用** | ~93.6 GiB
| **Docker 缓存** | ~427 GiB |
| **Swap** | 0 B |
