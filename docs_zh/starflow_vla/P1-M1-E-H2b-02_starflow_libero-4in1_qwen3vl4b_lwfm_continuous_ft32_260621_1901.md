...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 10.8 us,  3.9 sy,  0.0 ni, 85.2 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 90.9 GiB |
| **内存可用** | 916.6 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 0小时 0分钟 × 5.58 元/h ≈ **133.96 元** |
| **预计总成本** | 6天 5小时 20分钟 × 5.58 元/h ≈ **833.28 元** |
| **剩余预计成本** | 5天 5小时 19分钟 × 5.58 元/h ≈ **699.32 元** |
