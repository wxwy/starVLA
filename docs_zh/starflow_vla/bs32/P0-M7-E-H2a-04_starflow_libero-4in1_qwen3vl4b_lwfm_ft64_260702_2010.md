...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **28392 / 80000**（35.49%） |
| **单步耗时** | ~9.20 s/it |
| **已运行时间** | 约 72 小时 59 分钟 |
| **预计剩余时间** | ~132 小时（约 5.5 天） |
| **最新 checkpoint** | `steps_28250` |
| **上一个 checkpoint** | `steps_28000` |
| **下一轮 eval** | `steps_28500`（~108 steps 后）🔥 |
...
| 28380 | 0.0688 | 0.0795 | |
| 28392 | — | — | 🔵 当前 |
| **250–28250** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_28250** 已于 20:53 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_28250/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_28250`。
