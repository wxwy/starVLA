...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  8.3 us,  4.1 sy,  0.0 ni, 87.5 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 104.4 GiB |
| **内存可用** | 903.1 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 4小时 5分钟 × 5.58 元/h ≈ **156.74 元** |
| **预计总成本** | 6天 4小时 39分钟 × 5.58 元/h ≈ **829.56 元** |
| **剩余预计成本** | 5天 0小时 34分钟 × 5.58 元/h ≈ **672.82 元** |
