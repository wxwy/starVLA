...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 18.2 us,  4.9 sy,  0.0 ni, 76.6 id,  0.0 wa,  0.0 hi,  0.4 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 164.7 GiB |
| **内存可用** | 842.8 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 22小时 0分钟 × 5.58 元/h ≈ **122.85 元** |
| **预计总成本** | 6天 4小时 26分钟 × 5.58 元/h ≈ **828.32 元** |
| **剩余预计成本** | 5天 6小时 25分钟 × 5.58 元/h ≈ **705.47 元** |
