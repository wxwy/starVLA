...
> 最后更新：2026-07-05 01:15 CST（Docker 容器内实际可用资源）

| 指标 | 值 |
|------|-----|
| **当前 Step** | 21460 / 80,000（26.8%） |
| **完成比例** | 26.8% |
| **单步耗时** | ~6.81 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.208 s |
...
## 自动监控状态**: 🟢 训练运行中（step 21460/80000，约 26.8%）  

| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-07-05 01:15 CST |
| 训练状态**: 🟢 训练运行中（step 21460/80000，约 26.8%）  
| run_id | `P0-M7-E-H2a-01_starflow_libero-4in1_qwen3vl4b_lwfm_ft0_260703_0849` |
| tmux 会话 | `train` |
| 当前步数 | **21460 / 80000** |
| 完成比例 | 26.8% |
