...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **20997 / 80000**（26.25%） |
| **单步耗时** | ~9.17 s/it |
| **已运行时间** | 约 53 小时 59 分钟 |
| **预计剩余时间** | ~150 小时（约 6.3 天） |
| **最新 checkpoint** | `steps_20750` |
| **上一个 checkpoint** | `steps_20500` |
| **下一轮 eval** | `steps_21000`（~3 steps 后）🔥 |
...
| 20980 | 0.0722 | 0.0723 | |
| 20997 | — | — | 🔵 当前 |
| **250–20750** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_20750** 已于 01:37 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_20750/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_20750`。
