...
> 最后更新：2026-07-05 16:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **34800 / 80000**（43.5%） |
| **完成比例** | 43.5% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_34750` |
| **上一个 checkpoint** | `steps_34500` |
