...
> 最后更新：2026-07-04 05:26:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **16818 / 80000**（21.0%） |
| **完成比例** | 21.0% |
| **单步耗时** | ~7.00 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 31 小时 51 分钟 |
| **预计剩余时间** | ~120 小时（约 5.0 天） |
| **最新 checkpoint** | `steps_16250` |
| **上一个 checkpoint** | `steps_16000` |
