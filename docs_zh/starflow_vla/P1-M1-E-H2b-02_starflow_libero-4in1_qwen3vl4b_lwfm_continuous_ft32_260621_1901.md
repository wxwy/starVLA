...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  9.0 us,  4.1 sy,  0.0 ni, 86.8 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.6 GiB |
| **内存可用** | 910.9 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 4小时 29分钟 × 5.58 元/h ≈ **159.02 元** |
| **预计总成本** | 6天 4小时 0分钟 × 5.58 元/h ≈ **825.84 元** |
| **剩余预计成本** | 4天 23小时 30分钟 × 5.58 元/h ≈ **666.82 元** |
