...
> **状态**: 🟢 训练运行中（step 15744/80000，约 19.7%）  
> **启动时间**: 2026-06-22 11:48:42 CST  
> **最后训练日志**: 2026-06-22 16:36:59 CST，step 15740  
> **当前更新**: 2026-06-22 16:37:30 CST  
...
|------|------|
| **每 step 耗时** | ~1.09 秒 |
| **每 step 成本** | 5.58 / 3600 × 1.09 ≈ **0.0017 元** |
| **已产生成本** | 4.81 h × 5.58 ≈ **26.84 元** |
| **剩余 64256 steps 预估** | 64256 × 1.09s ≈ 19.5h ≈ **108.59 元** |
| **完整 80000 steps 预估** | 80000 × 1.09s ≈ 24.3h ≈ **135.43 元** |
