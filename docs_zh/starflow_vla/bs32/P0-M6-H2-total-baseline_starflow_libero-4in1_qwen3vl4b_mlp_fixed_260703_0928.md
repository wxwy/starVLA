...
> 最后更新：2026-07-03 22:19:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **12829 / 80000**（16.0%） |
| **完成比例** | 16.0% |
| **单步耗时** | ~3.34 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.095 s |
| **已运行时间** | 约 12 小时 |
| **预计剩余时间** | ~62 小时（约 2.6 天） |
| **最新 checkpoint** | `steps_12750` |
...
| **显存空闲** | 14,234 MiB |
| **功耗** | 145.63 W / 450.00 W |
| **温度** | 46°C |

> MLP head 显存仅 ~10.3 GB，loss 在 0.15-0.18 区间震荡，MLP 仍在缓慢学习。
...
| **Docker 内存已用** | ~20.1 GiB
| **Docker 内存可用** | ~35.9 GiB
| **Swap** | 0 B |
