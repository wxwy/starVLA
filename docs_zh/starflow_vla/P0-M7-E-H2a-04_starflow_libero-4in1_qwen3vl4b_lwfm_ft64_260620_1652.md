...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  6.0 us,  0.9 sy,  0.0 ni, 93.0 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 94.6 GiB |
| **内存可用** | 912.9 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 3小时 28分钟 × 5.58 元/h ≈ **19.39 元** |
| **预计总成本** | 6天 18小时 26分钟 × 5.58 元/h ≈ **906.44 元** |
| **剩余预计成本** | 6天 14小时 58分钟 × 5.58 元/h ≈ **887.05 元** |
...
| data_time | 0.0 s |
| model_time | 2.362 s |
| 最新完整 checkpoint | `steps_8250` |
| GPU | NVIDIA A100-SXM4-80GB |
| GPU 利用率 | 100% |
| 显存使用 | 65859 MiB / 81920 MiB (80.4%) |
| 功耗 | 311.09 W / 400.00 W |
| 温度 | 54°C |