...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 14.6 us,  9.1 sy,  0.0 ni, 75.9 id,  0.0 wa,  0.0 hi,  0.3 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 135.9 GiB |
| **内存可用** | 871.6 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 21小时 1分钟 × 5.58 元/h ≈ **117.28 元** |
| **预计总成本** | 6天 5小时 20分钟 × 5.58 元/h ≈ **833.28 元** |
| **剩余预计成本** | 5天 8小时 18分钟 × 5.58 元/h ≈ **716.00 元** |
