...
## 下一步
- 若继续推进 P0，runtime policy 的 checkpoint/save/resume 与离线 logging 已完成 prelaunch 确认；还需要完成第 4 步真实 WAM feature 接入，并确认长训资源预算后才能把 `policy_confirmed` / `launch_ready` 置为 true。
