...
> **状态**: ⏹️ 训练已结束（最后活跃 step ~260，最后 checkpoint `steps_250`，约 0.33%）  
> **启动时间**: 2026-06-21 14:21:08 CST  
> **最后 checkpoint**: 2026-06-21 14:52:29 CST (`steps_250`)  
> **当前更新**: 2026-06-21 14:57:20 CST  
> **tmux 会话**: `train`（当前会话已切换至 `P0-M7-E-H2a-04`）  
...
|------|------|
| **每 step 耗时** | ~7.52 秒 |
| **每 step 成本** | 5.58 / 3600 × 7.52 ≈ **0.0117 元** |
| **已产生成本** | ~0.52 h × 5.58 ≈ **2.92 元** |
| **剩余 79750 steps 预估** | 79750 × 7.52s = 166.7h ≈ **930.06 元** |
| **完整 80000 steps 预估** | 80000 × 7.52s = 167.2h ≈ **932.98 元** |
