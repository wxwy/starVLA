...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **27580 / 80000**（34.5%） |
| **完成比例** | 34.5% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 53 小时 51 分钟 |
| **预计剩余时间** | ~98 小时（约 4.1 天） |
| **最新 checkpoint** | `steps_27500` |
| **上一个 checkpoint** | `steps_27250` |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 4.2 天。
- step 27000+ loss 持续在 0.052 附近，训练进入平台期
