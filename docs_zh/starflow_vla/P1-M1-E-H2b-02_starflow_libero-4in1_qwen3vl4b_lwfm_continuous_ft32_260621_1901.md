...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 18.3 us,  5.1 sy,  0.0 ni, 76.1 id,  0.0 wa,  0.0 hi,  0.5 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 113.4 GiB |
| **内存可用** | 894.1 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 17小时 31分钟 × 5.58 元/h ≈ **97.74 元** |
| **预计总成本** | 6天 5小时 20分钟 × 5.58 元/h ≈ **833.28 元** |
| **剩余预计成本** | 5天 11小时 48分钟 × 5.58 元/h ≈ **735.54 元** |
