...
## 最新监控状态（2026-06-21 17:42 CST）

| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-06-21 17:42 CST |
| 训练状态 | ✅ 正常运行中 |
| 当前步数 | **13380 / 80000**（17%） |
| 最新完整 checkpoint | `steps_13375`（普通格式） |
| 最新 Loss | `action_dit_loss: 0.1128`（Step 13380） |
| 设备 | `NVIDIA A100-SXM4-80GB`（80 GB 显存） |
| 计费 | 5.58 元/h |
| GPU 利用率 | 100% |
| GPU 显存 | 63,473 MiB / 81,920 MiB（77.5%） |
| GPU 功耗 | 325.86 W / 400 W |
| GPU 温度 | 58°C |
| 训练速度 | 约 7.32 s/it |
| 已运行时间 | 4 小时 25 分钟 |
| 已产生成本 | **约 24.6 元** |
| 备注 | 当前 session 为 `P0-M5-E-H2a-03...250619`，`is_resume=True`；GPU 利用率恢复到 100%，功耗正常 |
