...
> 最后更新：2026-07-04 01:16:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **14760 / 80000**（18.5%） |
| **完成比例** | 18.5% |
| **单步耗时** | ~6.9-7.6 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.25 s |
| **已运行时间** | 约 28 小时 52 分钟 |
| **预计剩余时间** | ~125 小时（约 5.2 天） |
| **最新 checkpoint** | `steps_14750` |
| **上一个 checkpoint** | `steps_14500` |
...
| **Docker 内存已用** | 42.2 GiB |
| **Docker 内存可用** | ~13.8 GiB |
| **Swap** | 0 B |
