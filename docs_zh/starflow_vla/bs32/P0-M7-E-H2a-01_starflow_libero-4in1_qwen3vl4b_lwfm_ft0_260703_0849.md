...
> 最后更新：2026-07-08 08:37 CST（Docker 容器内实际可用资源）

| 指标 | 值 |
|------|-----|
| **当前 Step** | 63802 / 80,000（79.8%） |
| **完成比例** | 79.8% |
| **单步耗时** | ~6.55 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.212 s |
...
│   ├── steps_55000/          # 历史 checkpoint
│   ├── steps_59250/          # 历史 checkpoint
│   └── steps_63750/          # ✅ 最新完整 checkpoint
...
## 自动监控状态**: 🟢 训练运行中（step 63802/80000，约 79.8%）  

| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-07-08 08:37 CST |
| 训练状态**: 🟢 训练运行中（step 63802/80000，约 79.8%）  
| run_id | `P0-M7-E-H2a-01_starflow_libero-4in1_qwen3vl4b_lwfm_ft0_260703_0849` |
| tmux 会话 | `train` |
| 当前步数 | **63802 / 80000** |
| 完成比例 | 79.8% |
