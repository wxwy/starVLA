...
> **状态**: 🟢 训练运行中（step 271/80000，约 0.34%）  
> **启动时间**: 2026-06-21 14:21:08 CST  
> **当前更新**: 2026-06-21 14:54:10 CST  
> **tmux 会话**: `train`  
...
> 最后更新：2026-06-21 14:54:10 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | 271 / 80000 |
| **完成比例** | 0.34% |
| **单步耗时** | ~7.15 s/it（最新瞬时 7.17 s/it） |
| **数据加载耗时** | ~0.001 s |
| **模型前向/反向耗时** | ~1.78 s |
| **已运行时间** | ~33 分钟 |
| **预计剩余时间** | ~158.3 小时 |
| **预计总耗时** | ~158.8 小时 (~6.6 天) |
...
| **已产生成本** | ~0.55 h × 5.58 ≈ **3.05 元** |
| **预计剩余成本** | ~158.3 h × 5.58 ≈ **883.3 元** |
| **完整 80000 steps 预估** | 80000 × 7.15s = 158.8h ≈ **886.1 元** |
