...
> 最后更新：2026-07-03 20:19:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **10666 / 80000**（13.3%） |
| **完成比例** | 13.3% |
| **单步耗时** | ~3.35 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.105 s |
| **已运行时间** | 约 10 小时 |
| **预计剩余时间** | ~65 小时（约 2.7 天） |
| **最新 checkpoint** | `steps_10500` |
...
| **显存空闲** | 14,234 MiB |
| **功耗** | 147.86 W / 450.00 W |
| **温度** | 51°C |

> MLP head 显存仅 ~10.3 GB，loss 已降至 0.15 区间，MLP 收敛超出预期。
