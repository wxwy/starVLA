...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--encoder-name",
        default="wan2.2-ti2v-smoke-contract",
        help="Encoder name recorded in the contract only; no encoder is executed.",
    )
    parser.add_argument(
        "--episode-indices",
        type=int,
        nargs="+",
        default=[0, 1, 4],
        help="Episode indices to include in contract smoke.",
    )
    parser.add_argument(
        "--output",
        type=Path,
