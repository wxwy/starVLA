...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **30660 / 80000**（38.3%） |
| **完成比例** | 38.3% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 59 小时 51 分钟 |
| **预计剩余时间** | ~83 小时（约 3.5 天） |
| **最新 checkpoint** | `steps_30500` |
| **上一个 checkpoint** | `steps_30250` |
...
- step 30660 loss 降至 0.0512，创训练新低 🎯
