...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 10.1 us,  4.9 sy,  0.0 ni, 85.0 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.3 GiB |
| **内存可用** | 911.2 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 4小时 35分钟 × 5.58 元/h ≈ **159.56 元** |
| **预计总成本** | 6天 4小时 13分钟 × 5.58 元/h ≈ **827.08 元** |
| **剩余预计成本** | 4天 23小时 37分钟 × 5.58 元/h ≈ **667.52 元** |
