...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **30017 / 80000**（37.52%） |
| **单步耗时** | ~9.22 s/it |
| **已运行时间** | 约 77 小时 10 分钟 |
| **预计剩余时间** | ~128 小时（约 5.3 天） |
| **最新 checkpoint** | `steps_30000` |
| **上一个 checkpoint** | `steps_29750` |
| **下一轮 eval** | `steps_30500`（~483 steps 后） |
...
| 30017 | — | — | 🔵 当前 |
| **250–30000** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_30000** 已于 01:23 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_30000/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_30000`。
