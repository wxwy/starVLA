...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **26452 / 80000**（33.07%） |
| **单步耗时** | ~9.25 s/it |
| **已运行时间** | 约 67 小时 59 分钟 |
| **预计剩余时间** | ~138 小时（约 5.8 天） |
| **最新 checkpoint** | `steps_26250` |
| **上一个 checkpoint** | `steps_26000` |
| **下一轮 eval** | `steps_26500`（~48 steps 后）🔥 |
...
| 26440 | 0.0612 | 0.0639 | |
| 26452 | — | — | 🔵 当前 |
| **250–26250** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_26250** 已于 15:43 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_26250/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_26250`。
