...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **19513 / 80000**（24.39%） |
| **单步耗时** | ~9.28 s/it |
| **已运行时间** | 约 50 小时 10 分钟 |
| **预计剩余时间** | ~156 小时（约 6.5 天） |
| **最新 checkpoint** | `steps_19500` |
| **上一个 checkpoint** | `steps_19250` |
| **下一轮 eval** | `steps_20000`（~487 steps 后） |
...
| 19513 | — | — | 🔵 当前 |
| **250–19500** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_19500** 已于 22:24 保存并同步至持久存储

---

## 系统资源占用

> 最后更新：2026-07-04 22:30:00 CST
...
├── checkpoints/steps_250/ ... steps_19500/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_19500`。
