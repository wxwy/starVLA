...
> 最后更新：2026-07-03 21:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **12700 / 80000**（15.9%） |
| **完成比例** | 15.9% |
| **单步耗时** | ~7.2-8.3 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.35 s |
| **已运行时间** | 约 24 小时 51 分钟 |
| **预计剩余时间** | ~140 小时（约 5.8 天） |
| **最新 checkpoint** | `steps_12500` |
| **上一个 checkpoint** | `steps_12250` |
...
| **Docker 内存已用** | 42.1 GiB |
| **Docker 内存可用** | ~13.9 GiB |
| **Swap** | 0 B |
