...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 17.6 us,  1.3 sy,  0.0 ni, 81.0 id,  0.1 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 99.4 GiB |
| **内存可用** | 908.1 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1小时 33分钟 × 5.58 元/h ≈ **8.71 元** |
| **预计总成本** | 10天 18小时 13分钟 × 5.58 元/h ≈ **1440.88 元** |
| **剩余预计成本** | 10天 16小时 39分钟 × 5.58 元/h ≈ **1432.17 元** |
