...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **19440 / 80000**（24.30%） |
| **单步耗时** | ~9.18 s/it |
| **已运行时间** | 约 49 小时 59 分钟 |
| **预计剩余时间** | ~154 小时（约 6.4 天） |
| **最新 checkpoint** | `steps_19250` |
| **上一个 checkpoint** | `steps_19000` |
| **下一轮 eval** | `steps_19500`（~60 steps 后） |
...
| 19400 | 0.0709 | 0.0827 | |
| 19420 | 0.0708 | 0.0807 | |
| 19440 | 0.0815 | 0.0842 | 🔵 当前 |
| **250–19250** | — | — | ✅ 每 250 steps checkpoint |
...
- 最新 checkpoint **steps_19250** 已于 21:45 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_19250/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_19250`。
