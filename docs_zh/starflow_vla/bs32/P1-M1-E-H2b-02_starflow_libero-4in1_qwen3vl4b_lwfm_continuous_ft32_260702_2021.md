...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **25000 / 80000**（31.3%） |
| **完成比例** | 31.3% |
| **单步耗时** | ~7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.26 s |
| **已运行时间** | 约 48 小时 51 分钟 |
| **预计剩余时间** | ~106 小时（约 4.4 天） |
| **最新 checkpoint** | `steps_25000` |
| **上一个 checkpoint** | `steps_24750` |
| **Eval mse_score** | 0.0154（step 25000） |
...
| 25000 | 0.0724 | 0.0543 | 🔵 当前（mse=0.0154） |
...
| **Docker 内存已用** | 39.2 GiB |
| **Docker 内存可用** | ~16.8 GiB |
| **Swap** | 0 B |
...
- 速度 ~7.0 s/it，预计完整训练约 4.4 天。
- step 23000+ loss 在 0.06-0.09 区间，整体缓慢下降中。
- step 25000 eval mse=0.0154，较 step 24500 的 0.0124 略有回升。
