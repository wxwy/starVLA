...
> 最后更新：2026-07-04 19:26:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **24080 / 80000**（30.1%） |
| **完成比例** | 30.1% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.24 s |
| **已运行时间** | 约 47 小时 2 分钟 |
| **预计剩余时间** | ~107 小时（约 4.5 天） |
| **最新 checkpoint** | `steps_24000` |
| **上一个 checkpoint** | `steps_23750` |
...
| **Docker 内存已用** | 37.9 GiB |
| **Docker 内存可用** | ~18.1 GiB |
| **Swap** | 0 B |
