...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **24500 / 80000**（30.6%） |
| **完成比例** | 30.6% |
| **单步耗时** | ~7.0-7.1 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.25 s |
| **已运行时间** | 约 47 小时 51 分钟 |
| **预计剩余时间** | ~108 小时（约 4.5 天） |
| **最新 checkpoint** | `steps_24500` |
| **上一个 checkpoint** | `steps_24250` |
| **Eval mse_score** | 0.0124（step 24500） |
...
| 23980 | 0.0858 | 0.0534 | |
| 24080 | 0.0756 | 0.0310 | |
| 24500 | 0.0667 | 0.0879 | 🔵 当前（mse=0.0124） |
...
| **Docker 内存已用** | 39.1 GiB |
| **Docker 内存可用** | ~16.9 GiB |
| **Swap** | 0 B |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 4.5 天。
- step 23000+ loss 在 0.06-0.08 区间，整体缓慢下降中。
