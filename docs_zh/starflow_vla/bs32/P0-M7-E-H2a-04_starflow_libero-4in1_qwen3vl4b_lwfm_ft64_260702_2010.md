...
> 最后更新：2026-07-04 19:30:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **18346 / 80000**（22.93%） |
| **单步耗时** | ~9.21 s/it |
| **已运行时间** | 约 47 小时 10 分钟 |
| **预计剩余时间** | ~158 小时（约 6.6 天） |
| **最新 checkpoint** | `steps_18250` |
| **上一个 checkpoint** | `steps_18000` |
| **下一轮 eval** | `steps_18500`（~154 steps 后） |
