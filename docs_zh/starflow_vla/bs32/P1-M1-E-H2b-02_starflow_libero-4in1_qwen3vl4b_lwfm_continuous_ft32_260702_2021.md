...
> 最后更新：2026-07-04 18:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **23480 / 80000**（29.4%） |
| **完成比例** | 29.4% |
| **单步耗时** | ~6.9-7.1 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_23250` |
| **上一个 checkpoint** | `steps_23000` |
...
- 速度 ~6.9-7.1 s/it，预计完整训练约 4.5 天。
- step 23000+ loss 降至 0.06-0.07 区间，稳定下降中。
