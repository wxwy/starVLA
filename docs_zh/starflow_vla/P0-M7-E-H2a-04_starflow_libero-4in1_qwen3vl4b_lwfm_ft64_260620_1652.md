...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 12.7 us,  1.2 sy,  0.0 ni, 86.0 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 76.2 GiB |
| **内存可用** | 931.3 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 2小时 46分钟 × 5.58 元/h ≈ **15.50 元** |
| **预计总成本** | 8天 20小时 13分钟 × 5.58 元/h ≈ **1184.20 元** |
| **剩余预计成本** | 8天 17小时 26分钟 × 5.58 元/h ≈ **1168.70 元** |
