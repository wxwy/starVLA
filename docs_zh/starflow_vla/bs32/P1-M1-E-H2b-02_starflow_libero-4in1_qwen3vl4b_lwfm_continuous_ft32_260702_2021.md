...
> 最后更新：2026-07-05 13:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **33260 / 80000**（41.6%） |
| **完成比例** | 41.6% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_33250` |
| **上一个 checkpoint** | `steps_33000` |
...
| 指标 | 值 |
|------|-----|
| **GPU 利用率** | 5%（本机当前，可能 checkpoint 间隙） |
| **显存使用** | 23160 MiB / 24564 MiB（94.3%） |
| **显存空闲** | 1404 MiB |
| **功耗** | 273.34 W / 450.00 W |
| **温度** | 64°C |
