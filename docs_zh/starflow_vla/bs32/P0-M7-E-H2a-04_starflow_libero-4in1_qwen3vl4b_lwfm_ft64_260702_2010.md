...
| 27600 | 0.0621 | 0.0613 | |
| 27615 | — | — | 🔵 当前 |
| **250–27500** | — | — | ✅ 每 250 steps checkpoint |

### Loss 趋势

- 初始快速下降至 0.24（step 500），随后逐渐收敛
- 🔥🔥 **最佳 eval mse 0.00426**（step 27000），step 27500 eval mse=**0.00677**（回升，类似之前模式）
- step 13000–27600 损失在 0.047–0.12 之间震荡，无明显上升
- 学习率按 cosine schedule 缓慢衰减（当前 base LR ~1.86e-5）
- step 18000(0.00677) → 18500(0.00594) → 19000(0.00442) → 19500(0.00442) → 20000(0.00530) → 20500(0.00594) → 21000(0.01054 ⚠️) → 21500(0.00701) → 22000(0.00435) → 22500(0.00512) → 23000(0.00460) → 23500(0.00429) → 24000(0.00519) → 24500(0.00436) → 25000(0.00436) → 25500(0.00592) → 26000(0.00568) → 26500(0.00554) → 27000(**0.00426🏆**) → **27500(0.00677)**
- 最新 checkpoint **steps_27500** 已于 18:57 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_27500/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_27500`。
