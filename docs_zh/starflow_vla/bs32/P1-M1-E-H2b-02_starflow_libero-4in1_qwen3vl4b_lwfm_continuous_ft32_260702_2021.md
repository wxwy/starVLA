...
> 最后更新：2026-07-04 02:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **15260 / 80000**（19.1%） |
| **完成比例** | 19.1% |
| **单步耗时** | ~6.8-7.1 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.23 s |
| **已运行时间** | 约 29 小时 51 分钟 |
| **预计剩余时间** | ~122 小时（约 5.1 天） |
| **最新 checkpoint** | `steps_15250` |
| **上一个 checkpoint** | `steps_15000` |
...
| **Docker 内存已用** | 42.3 GiB |
| **Docker 内存可用** | ~13.7 GiB |
| **Swap** | 0 B |
