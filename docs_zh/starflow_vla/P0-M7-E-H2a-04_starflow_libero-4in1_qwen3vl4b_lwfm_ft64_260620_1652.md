...
|------|-----|
| **GPU 利用率** | 100% |
| **显存使用** | 65387 MiB / 81920 MiB (79.8%) |
| **显存空闲** | 15769 MiB |
| **功耗** | 324.82 W / 400.00 W |
| **温度** | 56°C |
...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  1.9 us,  0.8 sy,  0.0 ni, 97.2 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 67.5 GiB |
| **内存可用** | 940.0 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 5小时 16分钟 × 5.58 元/h ≈ **29.40 元** |
| **预计总成本** | 8天 17小时 6分钟 × 5.58 元/h ≈ **1166.84 元** |
| **剩余预计成本** | 8天 11小时 50分钟 × 5.58 元/h ≈ **1137.44 元** |
...
| data_time | 0.001 s |
| model_time | 2.397 s |
| 最新完整 checkpoint | `steps_7500` |
| GPU | NVIDIA A100-SXM4-80GB |
| GPU 利用率 | 100% |
| 显存使用 | 65859 MiB / 81920 MiB (80.4%) |
| 功耗 | 313.49 W / 400.00 W |
| 温度 | 54°C |
