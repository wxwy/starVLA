...
> 最后更新：2026-07-05 06:30:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **22629 / 80000**（28.29%） |
| **单步耗时** | ~9.22 s/it |
| **已运行时间** | 约 58 小时 10 分钟 |
| **预计剩余时间** | ~147 小时（约 6.1 天） |
| **最新 checkpoint** | `steps_22500` |
| **上一个 checkpoint** | `steps_22250` |
| **下一轮 eval** | `steps_23000`（~371 steps 后） |
