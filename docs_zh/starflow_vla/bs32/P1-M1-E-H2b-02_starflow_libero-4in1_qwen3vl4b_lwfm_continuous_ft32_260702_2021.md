...
> 最后更新：2026-07-05 12:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **32720 / 80000**（40.9%） |
| **完成比例** | 40.9% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_32500` |
| **上一个 checkpoint** | `steps_32250` |
...
| 指标 | 值 |
|------|-----|
| **GPU 利用率** | 0%（本机当前，可能 checkpoint 间隙） |
