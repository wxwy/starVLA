...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **11749 / 80000**（14.7%） |
| **完成比例** | 14.7% |
| **单步耗时** | ~3.50 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.143 s |
| **已运行时间** | 约 11 小时 |
| **预计剩余时间** | ~66 小时（约 2.8 天） |
...
| **显存空闲** | 14,234 MiB |
| **功耗** | 138.63 W / 450.00 W |
| **温度** | 47°C |

> MLP head 显存仅 ~10.3 GB，loss 已降至 0.15-0.17 区间，MLP 收敛超出预期。
...
| **Docker 内存已用** | ~21.4 GiB
| **Docker 内存可用** | ~34.6 GiB
| **Swap** | 0 B |
