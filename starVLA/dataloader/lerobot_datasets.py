...
def make_LeRobotSingleDataset(
    ...
    action_chunk_steps = data_cfg.get("action_chunk_steps", None) if data_cfg else None
    if (
        action_chunk_steps is None
        and latent_cache_cfg is not None
    ...
    if action_chunk_steps is not None and hasattr(data_config, "action_indices"):
