...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 19.6 us,  1.3 sy,  0.0 ni, 79.1 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 99.0 GiB |
| **内存可用** | 908.5 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1小时 59分钟 × 5.58 元/h ≈ **11.12 元** |
| **预计总成本** | 6天 23小时 33分钟 × 5.58 元/h ≈ **934.96 元** |
| **剩余预计成本** | 6天 21小时 33分钟 × 5.58 元/h ≈ **923.84 元** |
