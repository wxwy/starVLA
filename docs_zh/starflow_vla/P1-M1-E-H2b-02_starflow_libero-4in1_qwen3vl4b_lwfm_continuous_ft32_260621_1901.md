...
|------|-----|
| **GPU 利用率** | 70% |
| **显存使用** | 55901 MiB / 81920 MiB (68.2%) |
| **显存空闲** | 25255 MiB |
| **功耗** | 361.73 W / 400.00 W |
| **温度** | 58°C |
...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 12.7 us,  4.5 sy,  0.0 ni, 82.6 id,  0.1 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 97.4 GiB |
| **内存可用** | 910.1 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 2小时 29分钟 × 5.58 元/h ≈ **147.87 元** |
| **预计总成本** | 6天 5小时 6分钟 × 5.58 元/h ≈ **832.04 元** |
| **剩余预计成本** | 5天 2小时 36分钟 × 5.58 元/h ≈ **684.17 元** |
