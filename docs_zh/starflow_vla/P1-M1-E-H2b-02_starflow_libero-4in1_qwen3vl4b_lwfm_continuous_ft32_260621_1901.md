...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 21.2 us,  5.8 sy,  0.0 ni, 72.8 id,  0.0 wa,  0.0 hi,  0.3 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 125.2 GiB |
| **内存可用** | 882.3 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 20小时 0分钟 × 5.58 元/h ≈ **111.61 元** |
| **预计总成本** | 6天 4小时 26分钟 × 5.58 元/h ≈ **828.32 元** |
| **剩余预计成本** | 5天 8小时 26分钟 × 5.58 元/h ≈ **716.71 元** |
