...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 18.8 us,  6.2 sy,  0.0 ni, 74.8 id,  0.0 wa,  0.0 hi,  0.3 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 101.8 GiB |
| **内存可用** | 905.7 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 0小时 59分钟 × 5.58 元/h ≈ **5.55 元** |
| **预计总成本** | 6天 5小时 33分钟 × 5.58 元/h ≈ **834.52 元** |
| **剩余预计成本** | 6天 4小时 33分钟 × 5.58 元/h ≈ **828.97 元** |
