...
| 指标 | 值 |
|------|-----|
| **当前 Step** | **26560 / 80000**（33.2%） |
| **完成比例** | 33.2% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 51 小时 51 分钟 |
| **预计剩余时间** | ~102 小时（约 4.3 天） |
| **最新 checkpoint** | `steps_26500` |
| **上一个 checkpoint** | `steps_26250` |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 4.3 天。
- step 26000+ loss 持续在 0.052 附近，创训练新低 🎯
