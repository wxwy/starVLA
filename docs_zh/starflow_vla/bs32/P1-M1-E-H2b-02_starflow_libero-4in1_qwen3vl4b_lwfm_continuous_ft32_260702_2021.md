...
> 最后更新：2026-07-05 00:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **28100 / 80000**（35.1%） |
| **完成比例** | 35.1% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 54 小时 51 分钟 |
| **预计剩余时间** | ~96 小时（约 4.0 天） |
| **最新 checkpoint** | `steps_28000` |
| **上一个 checkpoint** | `steps_27750` |
...
| **Docker 内存已用** | 38.0 GiB |
| **Docker 内存可用** | ~18.0 GiB |
| **Swap** | 0 B |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 4.0 天。
- step 28000+ loss 在 0.059-0.061 区间，略有回升
