...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 11.6 us,  3.8 sy,  0.0 ni, 84.5 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 100.6 GiB |
| **内存可用** | 906.9 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 3小时 30分钟 × 5.58 元/h ≈ **153.50 元** |
| **预计总成本** | 6天 5小时 46分钟 × 5.58 元/h ≈ **835.76 元** |
| **剩余预计成本** | 5天 2小时 16分钟 × 5.58 元/h ≈ **682.26 元** |
