...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 17.7 us,  5.6 sy,  0.0 ni, 76.3 id,  0.0 wa,  0.0 hi,  0.4 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 165.9 GiB |
| **内存可用** | 841.6 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 23小时 1分钟 × 5.58 元/h ≈ **128.47 元** |
| **预计总成本** | 6天 5小时 6分钟 × 5.58 元/h ≈ **832.04 元** |
| **剩余预计成本** | 5天 6小时 5分钟 × 5.58 元/h ≈ **703.57 元** |
