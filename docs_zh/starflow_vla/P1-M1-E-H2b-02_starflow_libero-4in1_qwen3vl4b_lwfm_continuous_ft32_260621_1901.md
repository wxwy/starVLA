...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  5.9 us,  1.4 sy,  0.0 ni, 92.6 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 89.4 GiB |
| **内存可用** | 918.1 GiB |
...
| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-06-22 13:01:33 CST |
| 训练状态 | 🟡 未检测到活跃进度条 |
| run_id | `P1-M1-E-H2b-02_starflow_libero-4in1_qwen3vl4b_lwfm_continuous_ft32_260621_1901` |
| tmux 会话 | `train-2` |
| 当前步数 | 9500 / 80000（来自最新 checkpoint） |
