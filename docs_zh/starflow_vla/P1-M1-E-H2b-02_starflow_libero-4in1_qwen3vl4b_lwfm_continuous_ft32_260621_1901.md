...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  8.2 us,  3.3 sy,  0.0 ni, 88.4 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 101.9 GiB |
| **内存可用** | 905.6 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 3小时 35分钟 × 5.58 元/h ≈ **154.00 元** |
| **预计总成本** | 6天 4小时 39分钟 × 5.58 元/h ≈ **829.56 元** |
| **剩余预计成本** | 5天 1小时 4分钟 × 5.58 元/h ≈ **675.56 元** |
