...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 16.4 us,  3.6 sy,  0.0 ni, 79.7 id,  0.0 wa,  0.0 hi,  0.4 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 97.3 GiB |
| **内存可用** | 910.2 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 0小时 8分钟 × 5.58 元/h ≈ **0.79 元** |
| **预计总成本** | 6天 7小时 33分钟 × 5.58 元/h ≈ **845.68 元** |
| **剩余预计成本** | 6天 7小时 24分钟 × 5.58 元/h ≈ **844.89 元** |
