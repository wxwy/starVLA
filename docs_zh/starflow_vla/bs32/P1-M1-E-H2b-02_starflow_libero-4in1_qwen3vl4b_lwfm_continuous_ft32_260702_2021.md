...
> 最后更新：2026-07-03 19:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **11700 / 80000**（14.6%） |
| **完成比例** | 14.6% |
| **单步耗时** | ~6.9-7.3 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_11500` |
| **上一个 checkpoint** | `steps_11250` |
