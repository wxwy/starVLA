...
> 最后更新：2026-07-04 06:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **17320 / 80000**（21.7%） |
| **完成比例** | 21.7% |
| **单步耗时** | ~6.9-7.2 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.26 s |
| **已运行时间** | 约 33 小时 51 分钟 |
| **预计剩余时间** | ~119 小时（约 5.0 天） |
| **最新 checkpoint** | `steps_17250` |
| **上一个 checkpoint** | `steps_17000` |
...
| **Docker 内存已用** | 39.4 GiB |
| **Docker 内存可用** | ~16.6 GiB |
| **Swap** | 0 B |
