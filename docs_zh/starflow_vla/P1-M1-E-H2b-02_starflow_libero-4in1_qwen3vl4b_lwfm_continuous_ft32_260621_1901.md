...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 16.2 us,  5.4 sy,  0.0 ni, 78.0 id,  0.0 wa,  0.0 hi,  0.4 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 96.6 GiB |
| **内存可用** | 910.9 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 1小时 0分钟 × 5.58 元/h ≈ **139.51 元** |
| **预计总成本** | 6天 5小时 20分钟 × 5.58 元/h ≈ **833.28 元** |
| **剩余预计成本** | 5天 4小时 19分钟 × 5.58 元/h ≈ **693.77 元** |
