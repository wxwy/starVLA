...
> 最后更新：2026-07-06 01:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **39440 / 80000**（49.3%） |
| **完成比例** | 49.3% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_39250` |
| **上一个 checkpoint** | `steps_39000` |
