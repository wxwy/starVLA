...
> 最后更新：2026-07-03 22:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **13220 / 80000**（16.5%） |
| **完成比例** | 16.5% |
| **单步耗时** | ~6.8-7.2 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.23 s |
| **已运行时间** | 约 25 小时 51 分钟 |
| **预计剩余时间** | ~130 小时（约 5.4 天） |
| **最新 checkpoint** | `steps_13000` |
| **上一个 checkpoint** | `steps_12750` |
...
| **Docker 内存已用** | 40.7 GiB |
| **Docker 内存可用** | ~15.3 GiB |
| **Swap** | 0 B |
