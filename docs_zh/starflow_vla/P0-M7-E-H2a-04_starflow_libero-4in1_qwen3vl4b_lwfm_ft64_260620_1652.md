...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 12.8 us,  1.7 sy,  0.0 ni, 85.5 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 99.0 GiB |
| **内存可用** | 908.5 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1小时 58分钟 × 5.58 元/h ≈ **11.06 元** |
| **预计总成本** | 6天 21小时 20分钟 × 5.58 元/h ≈ **922.56 元** |
| **剩余预计成本** | 6天 19小时 21分钟 × 5.58 元/h ≈ **911.50 元** |
