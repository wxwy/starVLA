...
> **状态**: 🟢 训练运行中（step 2701/80000，约 3.4%）  
> **启动时间**: 2026-06-22 11:48:42 CST  
> **最后训练日志**: 2026-06-22 12:37:08 CST，step 2700  
> **当前更新**: 2026-06-22 12:37:30 CST  
...
| 400 | 0.3216 | |
| 1000 | — | ✅ checkpoint `steps_1000` |
| 2000 | — | ✅ checkpoint `steps_2000` |
| 2520 | 0.3031 | |
| 2540 | 0.2598 | |
| 2560 | 0.2139 | |
| 2580 | 0.2009 | |
...
|------|------|
| **每 step 耗时** | ~1.07 秒 |
| **每 step 成本** | 5.58 / 3600 × 1.07 ≈ **0.0017 元** |
| **已产生成本** | 0.81 h × 5.58 ≈ **4.52 元** |
| **剩余 77299 steps 预估** | 77299 × 1.07s ≈ 23.0h ≈ **128.34 元** |
| **完整 80000 steps 预估** | 80000 × 1.07s ≈ 23.8h ≈ **132.86 元** |
