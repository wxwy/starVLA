...
> 最后更新：2026-07-05 10:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **31700 / 80000**（39.6%） |
| **完成比例** | 39.6% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 61 小时 51 分钟 |
| **预计剩余时间** | ~77 小时（约 3.2 天） |
| **最新 checkpoint** | `steps_31500` |
| **上一个 checkpoint** | `steps_31250` |
...
- step 31700 loss 回升至 0.0551，normal 波动
