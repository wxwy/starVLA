...
| P0-M5-RESTART-1GPU | docs | `EXPERIMENT_MATRIX.md`, `ALGORITHM_OPTIMIZATION_PLAN.md`, `IMPLEMENTATION_LOG.md`, `PATCH_MANIFEST.md` | modified | 服务器重启后切单卡 40G 继续 E-H2a-03 baseline，统一 run_id / checkpoint 路径为 `P0-M5-E-H2a-03_..._ft32_250615`，`WANDB_MODE=online` |
