...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  6.8 us,  1.0 sy,  0.0 ni, 92.2 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 95.5 GiB |
| **内存可用** | 912.0 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 2小时 28分钟 × 5.58 元/h ≈ **13.82 元** |
| **预计总成本** | 6天 22小时 53分钟 × 5.58 元/h ≈ **931.24 元** |
| **剩余预计成本** | 6天 20小时 24分钟 × 5.58 元/h ≈ **917.42 元** |
