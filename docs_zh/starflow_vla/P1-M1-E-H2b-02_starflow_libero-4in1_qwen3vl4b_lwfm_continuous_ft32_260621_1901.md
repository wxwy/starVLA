...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 17.8 us,  5.5 sy,  0.0 ni, 76.5 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 128.0 GiB |
| **内存可用** | 879.5 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 18小时 32分钟 × 5.58 元/h ≈ **103.43 元** |
| **预计总成本** | 6天 4小时 53分钟 × 5.58 元/h ≈ **830.80 元** |
| **剩余预计成本** | 5天 10小时 21分钟 × 5.58 元/h ≈ **727.37 元** |
