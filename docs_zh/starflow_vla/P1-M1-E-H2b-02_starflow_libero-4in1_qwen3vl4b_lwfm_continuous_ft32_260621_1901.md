...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  4.9 us,  2.8 sy,  4.6 ni, 87.6 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 207.2 GiB |
| **内存可用** | 800.3 GiB |
...
| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-06-22 19:01:37 CST |
| 训练状态 | 🟡 未检测到活跃进度条 |
| run_id | `P1-M1-E-H2b-02_starflow_libero-4in1_qwen3vl4b_lwfm_continuous_ft32_260621_1901` |
| tmux 会话 | `train-2` |
| 当前步数 | 12500 / 80000（来自最新 checkpoint） |
