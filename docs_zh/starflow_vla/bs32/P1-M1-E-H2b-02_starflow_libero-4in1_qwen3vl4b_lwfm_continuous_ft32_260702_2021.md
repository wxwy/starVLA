...
> 最后更新：2026-07-06 16:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **50780 / 80000**（63.5%） |
| **完成比例** | 63.5% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 98 小时 51 分钟 |
| **预计剩余时间** | ~-2 小时（约 -0.1 天，超出预期） |
| **最新 checkpoint** | `steps_50750` |
| **上一个 checkpoint** | `steps_50500` |
...
| **Docker 内存已用** | 37.4 GiB |
| **Docker 内存可用** | ~18.6 GiB |
| **Swap** | 0 B |
