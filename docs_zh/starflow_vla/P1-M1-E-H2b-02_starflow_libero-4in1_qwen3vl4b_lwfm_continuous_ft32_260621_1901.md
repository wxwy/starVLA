...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 11.0 us,  4.7 sy,  0.0 ni, 84.2 id,  0.0 wa,  0.0 hi,  0.2 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 101.1 GiB |
| **内存可用** | 906.4 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 1小时 30分钟 × 5.58 元/h ≈ **142.30 元** |
| **预计总成本** | 6天 4小时 13分钟 × 5.58 元/h ≈ **827.08 元** |
| **剩余预计成本** | 5天 2小时 43分钟 × 5.58 元/h ≈ **684.78 元** |
