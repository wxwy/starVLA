...
> 最后更新：2026-07-07 12:35:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **53340 / 80000**（66.7%） |
| **完成比例** | 66.7% |
| **单步耗时** | ~6.62 s/it |
| **模型前向/反向耗时** | ~0.21 s |
| **数据加载耗时** | ~0.000 s |
| **已运行时间** | 约 99 小时（4.1 天） |
| **预计剩余时间** | ~49 小时（约 2.0 天） |
...
- GPU 利用率 30%（因 per_device_batch=1, grad_accum=32 同步开销大）
