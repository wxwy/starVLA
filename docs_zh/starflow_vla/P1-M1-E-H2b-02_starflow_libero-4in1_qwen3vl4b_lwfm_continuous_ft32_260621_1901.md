...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s):  9.7 us,  2.9 sy,  0.0 ni, 87.1 id,  0.0 wa,  0.0 hi,  0.3 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 100.8 GiB |
| **内存可用** | 906.7 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1天 3小时 1分钟 × 5.58 元/h ≈ **150.76 元** |
| **预计总成本** | 6天 4小时 0分钟 × 5.58 元/h ≈ **825.84 元** |
| **剩余预计成本** | 5天 0小时 58分钟 × 5.58 元/h ≈ **675.08 元** |
