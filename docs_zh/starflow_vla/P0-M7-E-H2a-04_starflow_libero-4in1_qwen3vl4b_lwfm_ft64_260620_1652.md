...
| 指标 | 值 |
|------|-----|
| **CPU 使用率** | %Cpu(s): 13.4 us,  1.7 sy,  0.0 ni, 84.8 id,  0.0 wa,  0.0 hi,  0.1 si,  0.0 st |
| **内存总量** | 1007.5 GiB |
| **内存已用** | 98.7 GiB |
| **内存可用** | 908.8 GiB |
...
| 项目 | 计算 |
|------|------|
| **已产生成本** | 1小时 58分钟 × 5.58 元/h ≈ **11.04 元** |
| **预计总成本** | 6天 21小时 6分钟 × 5.58 元/h ≈ **921.32 元** |
| **剩余预计成本** | 6天 19小时 7分钟 × 5.58 元/h ≈ **910.28 元** |
