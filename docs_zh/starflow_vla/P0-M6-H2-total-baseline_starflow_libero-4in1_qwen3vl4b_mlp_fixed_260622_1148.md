...
> **状态**: 🟢 训练运行中（step 9231/80000，约 11.5%）  
> **启动时间**: 2026-06-22 11:48:42 CST  
> **最后训练日志**: 2026-06-22 14:36:51 CST，step 9220  
> **当前更新**: 2026-06-22 14:37:30 CST  
...
|------|------|
| **每 step 耗时** | ~1.08 秒 |
| **每 step 成本** | 5.58 / 3600 × 1.08 ≈ **0.0017 元** |
| **已产生成本** | 2.81 h × 5.58 ≈ **15.67 元** |
| **剩余 70769 steps 预估** | 70769 × 1.08s ≈ 21.2h ≈ **118.47 元** |
| **完整 80000 steps 预估** | 80000 × 1.08s ≈ 24.0h ≈ **134.14 元** |
