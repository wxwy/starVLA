...
> 最后更新：2026-07-05 22:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **37900 / 80000**（47.4%） |
| **完成比例** | 47.4% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 73 小时 51 分钟 |
| **预计剩余时间** | ~50 小时（约 2.1 天） |
| **最新 checkpoint** | `steps_37750` |
| **上一个 checkpoint** | `steps_37500` |
