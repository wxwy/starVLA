...
> 最后更新：2026-07-06 10:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **44100 / 80000**（55.1%） |
| **完成比例** | 55.1% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 85 小时 51 分钟 |
| **预计剩余时间** | ~26 小时（约 1.1 天） |
| **最新 checkpoint** | `steps_44000` |
| **上一个 checkpoint** | `steps_43750` |
