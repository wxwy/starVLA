...
> 最后更新：2026-07-04 15:15 CST（Docker 容器内实际可用资源）

| 指标 | 值 |
|------|-----|
| **当前 Step** | 16191 / 80,000（20.2%） |
| **完成比例** | 20.2% |
| **单步耗时** | ~6.97 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.212 s |
...
## 自动监控状态**: 🟢 训练运行中（step 16191/80000，约 20.2%）  

| 字段 | 值 |
| --- | --- |
| 监控时间 | 2026-07-04 15:15 CST |
| 训练状态**: 🟢 训练运行中（step 16191/80000，约 20.2%）  
| run_id | `P0-M7-E-H2a-01_starflow_libero-4in1_qwen3vl4b_lwfm_ft0_260703_0849` |
| tmux 会话 | `train` |
| 当前步数 | **16191 / 80000** |
| 完成比例 | 20.2% |
