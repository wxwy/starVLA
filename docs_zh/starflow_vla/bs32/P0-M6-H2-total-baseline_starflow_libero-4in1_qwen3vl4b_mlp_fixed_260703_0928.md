...
> 最后更新：2026-07-04 08:19:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **34470 / 80000**（43.1%） |
| **完成比例** | 43.1% |
| **单步耗时** | ~3.48 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.128 s |
| **已运行时间** | 约 32 小时 |
| **预计剩余时间** | ~44 小时（约 1.8 天） |
| **最新 checkpoint** | `steps_34250` |
...
- 初始 0.25 → 持续稳步下降，全阶段无明显瓶颈
- step 30000 后跌破 0.12，34460 低至 **0.105**
- MLP baseline 收敛远超预期，接近 DiT ft32 的 loss 水平
