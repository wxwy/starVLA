...
> 最后更新：2026-07-03 17:07:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **10242 / 80000**（12.8%） |
| **完成比例** | 12.8% |
| **单步耗时** | ~7.10 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.23 s |
...
| 指标 | 值 |
|------|-----|
| **Docker 内存总量** | 56 GiB（cgroup v2 memory.max） |
| **Docker 内存已用** | ~45 GiB |
| **Docker 内存可用** | ~11 GiB |
| **Swap** | 0 B |
