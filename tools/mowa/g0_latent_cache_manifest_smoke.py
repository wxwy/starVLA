"""MoWA G0 latent cache manifest smoke check."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MoWA latent cache manifest smoke check.")
    parser.add_argument(
        "--data-root",
        type=Path,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[0, 1, 4],
        help="Episode indices to include in manifest smoke.",
    )
    parser.add_argument(
        "--output",
        type=Path,
