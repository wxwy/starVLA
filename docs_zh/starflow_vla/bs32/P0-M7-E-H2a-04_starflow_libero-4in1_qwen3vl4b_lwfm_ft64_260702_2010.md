...
- 最新 checkpoint **steps_23250** 已于 08:01 保存并同步至持久存储
...
├── checkpoints/steps_250/ ... steps_23250/  ✅
├── config.full.yaml          ✅
├── config.yaml               ✅
...
- checkpoint 每 250 steps 正常保存至 `steps_23250`。
