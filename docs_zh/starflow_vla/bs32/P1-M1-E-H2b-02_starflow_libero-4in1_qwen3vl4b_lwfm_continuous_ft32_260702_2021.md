...
> 最后更新：2026-07-06 09:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **43580 / 80000**（54.5%） |
| **完成比例** | 54.5% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_43500` |
| **上一个 checkpoint** | `steps_43250` |
