...
> 最后更新：2026-07-06 13:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **45620 / 80000**（57.0%） |
| **完成比例** | 57.0% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_45500` |
| **上一个 checkpoint** | `steps_45250` |
...
| 44600 | 0.0398 | 0.0682 | |
| 45120 | 0.0479 | 0.0291 | |
| 45620 | 0.0410 | 0.0962 | 🔵 当前（step 45600 曾达 0.0337 新低 🎯） |
