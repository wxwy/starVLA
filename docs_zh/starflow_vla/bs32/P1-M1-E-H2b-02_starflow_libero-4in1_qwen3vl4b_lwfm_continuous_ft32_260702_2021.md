...
> 最后更新：2026-07-04 22:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **25520 / 80000**（31.9%） |
| **完成比例** | 31.9% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.23 s |
| **已运行时间** | 约 49 小时 51 分钟 |
| **预计剩余时间** | ~105 小时（约 4.4 天） |
| **最新 checkpoint** | `steps_25500` |
| **上一个 checkpoint** | `steps_25250` |
