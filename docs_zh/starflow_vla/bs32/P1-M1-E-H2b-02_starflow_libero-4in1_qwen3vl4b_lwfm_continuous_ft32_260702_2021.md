...
> 最后更新：2026-07-02 22:30:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **1062 / 80000**（1.3%） |
| **完成比例** | 1.3% |
| **单步耗时** | ~7.15–7.32 s/it |
| **数据加载耗时** | ~0.0004 s |
| **模型前向/反向耗时** | ~0.23 s |
| **已运行时间** | 约 2 小时 5 分钟 |
| **预计剩余时间** | ~160 小时（约 6.7 天） |
| **最新 checkpoint** | `steps_1000` |
| **上一个 checkpoint** | `steps_750` |
...
- `last_micro_loss` 波动较大（0.15–0.62），表明单个 micro-batch 方差较高
- `action_dit_loss`（32 micro-step 均值）逐渐稳定在 0.19–0.24
...
|------|-----|
| **GPU 利用率** | 58% |
| **显存使用** | 23,160 MiB / 24,564 MiB（94.3%） |
| **显存空闲** | 1,404 MiB |
| **功耗** | 287.06 W / 450.00 W |
| **温度** | 58°C |
