...
> 最后更新：2026-07-05 19:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **36340 / 80000**（45.4%） |
| **完成比例** | 45.4% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
...
| **最新 checkpoint** | `steps_36250` |
| **上一个 checkpoint** | `steps_36000` |
