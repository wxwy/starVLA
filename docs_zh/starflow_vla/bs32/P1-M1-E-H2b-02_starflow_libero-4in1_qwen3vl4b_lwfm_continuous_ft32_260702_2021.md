...
> 最后更新：2026-07-05 08:15:00 CST

| 指标 | 值 |
|------|-----|
| **当前 Step** | **30760 / 80000**（38.5%） |
| **完成比例** | 38.5% |
| **单步耗时** | ~6.9-7.0 s/it |
| **数据加载耗时** | ~0.000 s |
| **模型前向/反向耗时** | ~0.21-0.22 s |
| **已运行时间** | 约 60 小时 2 分钟 |
| **预计剩余时间** | ~82 小时（约 3.4 天） |
| **最新 checkpoint** | `steps_30750` |
| **上一个 checkpoint** | `steps_30500` |
...
- 速度 ~6.9-7.0 s/it，预计完整训练约 3.5 天。
- 🎯 达成 30k steps 里程碑，loss 维持 0.056 低位
- step 30760 loss 降至 0.0459，再创训练新低 🎯
